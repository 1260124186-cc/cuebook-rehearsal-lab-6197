# cuebook-rehearsal-lab__012 Docker 交付说明
...
```bash
./build_benzhi_docker.sh cuebook-rehearsal-lab__012-benzhi linux/amd64
docker run --rm -it cuebook-rehearsal-lab__012-benzhi bash
```
