...
var rememberedCreateID string

func reuseCreateID(id string) string {
	if rememberedCreateID != "" {
		return rememberedCreateID
	}
	rememberedCreateID = id
	return id
}
